<?php /* Template Name: Home - Lord Theme */ get_header(); ?>
...
<div id="popup-overlay">
	<div class="container">
		<div id="popup" class="cp-popup-holder">
			<div class="cp-inner"> <a href="#" id="popup-close"><i class="fa fa-close"></i></a>
				<h2>Newsletter</h2>
				<strong class="title">Our Newsletter</strong>
				<p>Subscribe to the <span>Church mailing</span> list to receive updates on new arrivals, offers and other discount information.</p>
				<form method="post">
					<input type="text" placeholder="Email">
					<button class="subscribe" type="submit">Subscribe</button>
					<input type="checkbox" value="">
					Don't show it again<br>
				</form>
			</div>
		</div>
	</div>
...
<div id="banner">
	<div id="home-banner" class="owl-carousel owl-theme">
		<div class="item"> <img src="<?php echo get_template_directory_uri(); ?>/images/banner-img-1.jpg" alt="img">
			<div class="caption">
				<div class="container"> <span>nO ONE COMES TO THE fATHER EXCEPT THROUGH ME.</span>
					<h1>I AM THE WAY, THE TRUTH</h1>
					<div class="btn-row"> <a href="sermons.html" class="btn-style-1">Sermon Series</a> </div>
				</div>
			</div>
		</div>
		<div class="item"> <img src="<?php echo get_template_directory_uri(); ?>/images/banner-img-2.jpg" alt="img">
			<div class="caption">
				<div class="container"> <span>nO ONE COMES TO THE fATHER EXCEPT THROUGH ME.</span>
					<h1>I AM THE WAY, THE TRUTH</h1>
					<div class="btn-row"> <a href="sermons.html" class="btn-style-1">Sermon Series</a> </div>
	...
	<section class="home-about">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="frame-1"><img src="<?php echo get_template_directory_uri(); ?>/images/about-img-1.jpg" alt="img"></div>
					<div class="frame-2"><img src="<?php echo get_template_directory_uri(); ?>/images/about-img-2.jpg" alt="img"></div>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid">
			<div class="col-md-7 col-sm-7">
				<div class="holder">
					...
					<div class="event-col">
						<div class="thumb"> <img src="<?php echo get_template_directory_uri(); ?>/images/event-img-1.jpg" alt="img"> <strong class="date">18 <span>JuLY</span></strong> </div>
					...
					<div class="event-col">
						<div class="thumb"> <img src="<?php echo get_template_directory_uri(); ?>/images/event-img-2.jpg" alt="img"> <strong class="date">16 <span>JuLY</span></strong> </div>
						<div class="text-box"> <a href="event-detail.html">Join us throughout the week to serve our city.</a> <span>Saturday, 10:00 am - 2:00 pm Upcoming. State Route </span>
							<ul class="links">
								<li><a href="#"><span class="icon-compass"></span></a></li>
								<li><a href="#"><span class="icon-share-button-outline"></span></a></li>
					...
					<div class="event-col">
						<div class="thumb"> <img src="<?php echo get_template_directory_uri(); ?>/images/event-img-3.jpg" alt="img"> <strong class="date">12 <span>JuLY</span></strong> </div>
						<div class="text-box"> <a href="event-detail.html">Join us throughout the week to serve our city.</a> <span>Saturday, 10:00 am - 2:00 pm Upcoming. State Route </span>
							<ul class="links">
								<li><a href="#"><span class="icon-compass"></span></a></li>
								<li><a href="#"><span class="icon-share-button-outline"></span></a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/pastor-img-1.jpg" alt="img">
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/pastor-img-2.jpg" alt="img">
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/pastor-img-3.jpg" alt="img">
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/pastor-img-4.jpg" alt="img">
						<div class="caption">
							<div class="holder"> <a href="#" class="title">Jonatha Doe</a> <span>Senior Member</span> </div>
						</div>
						<div class="hover-box">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					...
					<div class="sermon-box">
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/sermon-img-1.jpg" alt="img"></div>
					...
					<div class="sermon-box">
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/sermon-img-2.jpg" alt="img"></div>
						<div class="holder"> <a href="#" class="btn-play"><span class="icon-play-button"></span></a>
					...
					<div class="sermon-box">
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/sermon-img-3.jpg" alt="img"></div>
						<div class="holder"> <a href="#" class="btn-play"><span class="icon-play-button"></span></a>
					...
					<div class="sermon-box">
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/sermon-img-4.jpg" alt="img"></div>
						<div class="holder"> <a href="#" class="btn-play"><span class="icon-play-button"></span></a>
					...
					<div class="store-box">
						<div class="store-banner owl-carousel owl-theme">
							<div class="item">
								...
								<div class="frame"><img src="<?php echo get_template_directory_uri(); ?>/images/store-home-img-1.jpg" alt="img"></div>
								<div class="text-box">
							...
							<div class="item">
								...
								<div class="frame"><img src="<?php echo get_template_directory_uri(); ?>/images/store-home-img-2.jpg" alt="img"></div>
								<div class="text-box">
									<h3>Join us throughout the week</h3>
									<strong class="amount">$143.00   -   $120:00</strong>
									<p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur pharetra risus in elit luctus, sit amet volutpat diam mollis</p>
							...
							<div class="item">
								...
								<div class="frame"><img src="<?php echo get_template_directory_uri(); ?>/images/store-home-img-3.jpg" alt="img"></div>
								<div class="text-box">
									<h3>Join us throughout the week</h3>
									<strong class="amount">$143.00   -   $120:00</strong>
									<p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur pharetra risus in elit luctus, sit amet volutpat diam mollis</p>
	...
	<section class="gallery-style-1">
		...
		<div class="container-fluid">
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-1.jpg" alt="img">
					<div class="caption">
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-2.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-3.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-4.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-5.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-6.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-7.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-8.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-9.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-10.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-11.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="col-md-2 col-sm-4">
				<div class="frame"> <img src="<?php echo get_template_directory_uri(); ?>/images/gallery/gallery-style-1-img-12.jpg" alt="img">
					<div class="caption">
						<div class="holder"> <a href="#" class="link"><i class="fa fa-link" aria-hidden="true"></i></a> <strong class="title">Holy Spirit: Strategic </strong> <span>Chruch- Furniture</span> </div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4">
					<div class="blog-style-1"> <a href="blog-detail.html" class="title">The Lord, GOD Of Our Lifes</a> <span>6/26 S/2016 . Category Religion</span>
						...
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/blog-style-1-img-1.jpg" alt="img"></div>
				...
				<div class="col-md-4 col-sm-4">
					<div class="blog-style-1"> <a href="blog-detail.html" class="title">Reaching Kids Education</a> <span>6/26 S/2016 . Category Religion</span>
						<p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur pharetra risus in elit luctus, sit a mollis...{+}</p>
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/blog-style-1-img-2.jpg" alt="img"></div>
				...
				<div class="col-md-4 col-sm-4">
					<div class="blog-style-1"> <a href="blog-detail.html" class="title">Service Day: A Family Affair!</a> <span>6/26 S/2016 . Category Religion</span>
						...
						<div class="round-frame"><img src="<?php echo get_template_directory_uri(); ?>/images/blog-style-1-img-3.jpg" alt="img"></div>
