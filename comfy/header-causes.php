...
<html <?php language_attributes(); ?> class="no-js">
 ...
 <body <?php body_class(); ?> class="theme-style-1">
				<!--WRAPPER START-->
								<div id="wrapper">
								  <!--HEADER START-->
								  <header id="header" class="causes-header">
										<!-- logo -->
										<div class="container-fluid"> <strong class="logo">
											<a href="<?php echo home_url(); ?>">
												<img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="img"></a></strong>
										</div>
										<!-- /logo -->
								      <div class="navigation-row">
								        <div class="top-search"> <a href="#" class="search-icon" id="search-push"><i class="fa fa-search"></i></a> </div>
								        <!--BURGER NAVIGATION SECTION START-->
								        <div class="cp-burger-nav home-6">
								          <!--BURGER NAV BUTTON-->
								          <div id="cp_side-menu-btn" class="cp_side-menu"><a href="#" class=""><img src="<?php echo get_template_directory_uri(); ?>/images/menu-icon.png" alt="img"></a></div>
								          <!--BURGER NAV BUTTON-->
