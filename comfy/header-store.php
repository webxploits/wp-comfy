	  ...
	  <header id="header" class="header-style-2">
			...
			<div class="container-fluid"> <strong class="logo">
				<a href="<?php echo home_url(); ?>">
					<img src="<?php echo get_template_directory_uri(); ?>/images/logo-2.png" alt="img"></a></strong>
			</div>
			<!-- /logo -->
	      ...
	      <div class="navigation-row">
	        ...
	        <div class="cp-burger-nav home-2">
	          <!--BURGER NAV BUTTON-->
	          <div id="cp_side-menu-btn" class="cp_side-menu"><a href="#" class=""><img src="<?php echo get_template_directory_uri(); ?>/images/menu-icon-2.png" alt="img"></a></div>
	          <!--BURGER NAV BUTTON-->
